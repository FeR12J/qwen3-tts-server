...
def create_whisper_routes(app: FastAPI, semaphore):
    """Crear las rutas de transcripción de audio."""
    ...
    async def transcribe_endpoint(
        ...
        async with semaphore:
            ...
            if len(data) > MAX_TRANSCRIBE_AUDIO_BYTES:
                raise HTTPException(400, f"El archivo excede {MAX_TRANSCRIBE_AUDIO_BYTES // (1024 * 1024)} MB")
